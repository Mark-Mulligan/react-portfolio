  ...
  return (
    <section className={`about-section ${isBrowser ? 'parallax-img' : ''}`}>
      <div className="container text-center p-5">
        <h2 className="section-title off-white" id="my-approach">
          My Approach
        </h2>
      </div>
      ...
      <div className="container skills-container">
        <div class="text-center">
          <h2 class="section-title off-white" id="about">
            About
          </h2>
        </div>

        <p class="bio off-white">
          Hey, I'm Mark, a Front End Developer based in Dallas TX. I love to build amazing websites with simple,
          intuitive user interfaces. I am always looking for new things to learn and projects to take on.{' '}
